package Alibrary.Linear;

import Alibrary.Linear.array.ArrayStack;
import Alibrary.Linear.list.LinkedListStack;
import Alibrary.Linear.list.ListNode;
import Alibrary.Linear.queue.Deque;
...
public class DSMain {
    ...
    private static double testStack(Alibrary.Linear.stack.Stack<Integer> stack, int opCount) {
