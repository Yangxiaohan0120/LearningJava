...
public class MyPanel extends JPanel implements KeyListener, Runnable {
    ...
    public MyPanel() {
        ...
        //初始化图片对象
        image1 = Toolkit.getDefaultToolkit().getImage(new File("/Users/yxh/IntelliJProjects/LearningJava/src/main/java/Project/tankgame4/bomb_1.gif").getAbsolutePath());
        image2 = Toolkit.getDefaultToolkit().getImage(new File("/Users/yxh/IntelliJProjects/LearningJava/src/main/java/Project/tankgame4/bomb_2.gif").getAbsolutePath());
        image3 = Toolkit.getDefaultToolkit().getImage(new File("/Users/yxh/IntelliJProjects/LearningJava/src/main/java/Project/tankgame4/bomb_3.gif").getAbsolutePath());
    }
